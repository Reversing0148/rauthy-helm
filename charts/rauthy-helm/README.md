...
## Installation
```bash
helm upgrade --install rauthy oci://ghcr.io/reversing0148/rauthy-helm --version 1.0.8 -n rauthy --create-namespace
```
...
```bash
helm upgrade --install rauthy oci://ghcr.io/reversing0148/rauthy-helm --version 1.0.8 -n rauthy
```
